...
def ingest_new_finn_ads(client, search_key, published_today="True"):
    ...
    while page < 51:
        ...
        # URL = f"https://www.finn.no/realestate/newbuildings/search.html?filters=&published={published}&page={page}&_data=routes%2Frealestate%2B%2F_search%2B%2F%24subvertical.search%5B.html%5D"
