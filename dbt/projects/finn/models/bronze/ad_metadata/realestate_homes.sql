...
SELECT
    ...
    (doc->>"$.owner_type_description")                  ::VARCHAR AS owner_type_description,
    ...
    (doc->"$.price_range_suggestion.amount_from")       ::UBIGINT AS price_range_suggestion_amount_from,
    (doc->"$.price_range_suggestion.amount_to")         ::UBIGINT AS price_range_suggestion_amount_to,
    (doc->>"$.price_range_suggestion.currency_code")    ::VARCHAR AS price_range_suggestion_currency_code,
    (doc->"$.price_range_total.amount_from")            ::UBIGINT AS price_range_total_amount_from,
    (doc->"$.price_range_total.amount_to")              ::UBIGINT AS price_range_total_amount_to,
    (doc->>"$.price_range_total.currency_code")         ::VARCHAR AS price_range_total_currency_code,
    (doc->"$.bedrooms_range.start")                     ::UBIGINT AS bedrooms_range_start,
    (doc->"$.bedrooms_range.end")                       ::UBIGINT AS bedrooms_range_end,
